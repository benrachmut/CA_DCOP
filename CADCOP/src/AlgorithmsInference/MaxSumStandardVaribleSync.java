...
public class MaxSumStandardVaribleSync extends MaxSumStandardVarible {
	...
	protected void printStoredMessage(MsgAlgorithmFactor msg) {
		...
		System.out.println("Iteration:" + currentIteration + ", VariableNode:(" + msg.getSenderId().getId1() + ","
				+ msg.getSenderId().getId2() + ") STORED a message for FunctionNode ("
	...
	protected void printSentdMessage(MsgAlgorithmFactor msg) {
		...
		System.out.println("Iteration:" + currentIteration + ",VariableNode:(" + msg.getSenderId().getId1() + ","
				+ msg.getSenderId().getId2() + ") SENT a message for FunctionNode ("
	...
	protected void printReceivedMessage(MsgAlgorithmFactor msg) {
		...
		System.out.println("Iteration:" + currentIteration + ",VariableNode:(" + msg.getRecieverId().getId1() + ","
	...
	// System.out.println("VariableNode:(" + this.getNodeId().getId1() + "," +
	// this.getNodeId().getId2() + ") value assignment is:" + valueAssignment
	// +".\n");
